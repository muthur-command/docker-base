...
The image include [S6-Overlay](https://github.com/just-containers/s6-overlay), [Bashio](https://github.com/mcos-addons/bashio) and [TempIO](https://github.com/muthur-command/tempio).
